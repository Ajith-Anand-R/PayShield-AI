...
Calculated on 2026-06-24 19:29:35
...
| Metric | Value |
| :--- | :--- |
| **Throughput** | 25.46 req/sec |
| **Total Test Duration** | 3.93 seconds |
| **Successful Requests** | 100 |
| **Failed Requests** | 0 |
| **Min Latency** | 31.23 ms |
| **Average Latency** | 39.23 ms |
| **p50 Latency** | 39.01 ms |
| **p95 Latency** | 46.41 ms |
| **p99 Latency** | 53.19 ms |
| **Max Latency** | 55.51 ms |
